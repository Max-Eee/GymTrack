        ...
        children: [
          ...
          ClipRRect(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: [
                  // Gradient bar (underweight → normal → overweight → obese)
                  Row(
                    children: [
                      Expanded(flex: 35, child: Container(color: const Color(0xFF60A5FA))),
                      Expanded(flex: 30, child: Container(color: AppColors.success)),
                      Expanded(flex: 15, child: Container(color: const Color(0xFFFBBF24))),
                      Expanded(flex: 20, child: Container(color: AppColors.danger)),
                    ],
                  ),
                  // Position indicator
          ...
          Row(
            ...
            children: [
              Text('15', style: TextStyle(color: AppColors.textMutedDark, fontSize: 10)),
              Text('18.5', style: TextStyle(color: AppColors.textMutedDark, fontSize: 10)),
              Text('25', style: TextStyle(color: AppColors.textMutedDark, fontSize: 10)),
              Text('30', style: TextStyle(color: AppColors.textMutedDark, fontSize: 10)),
              Text('40', style: TextStyle(color: AppColors.textMutedDark, fontSize: 10)),
            ],
          ),
          ...
          if (advice.isNotEmpty)
            Row(
              ...
              children: [
                Icon(
                  bmi >= 18.5 && bmi < 25 ? Icons.check_circle_rounded : Icons.info_outline_rounded,
                  color: color,
                  size: 16,
                ),
                const SizedBox(width: 8),
            ...
            data: (equipment) {
              ...
              return ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  return _buildEquipmentTile(type, isSelected, equipment);
                },
              );
            },
          ),
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 12),
          Text(
            'Your personal fitness companion.\nTrack workouts, manage equipment, and crush your goals.',
